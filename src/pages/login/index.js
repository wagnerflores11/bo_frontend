      ...
      if (errorMessage) {
        if (errorMessage.errors) {
          for (var key in errorMessage.errors) {
            setError(key, {
              type: 'manual',
              message: errorMessage.errors[key][0]
            })
      ...
      <RightWrapper sx={skin === 'bordered' && !hidden ? { borderLeft: `1px solid ${theme.palette.divider}` } : {}}>
        ...
        >
          <BoxWrapper>
            ...
            <Box sx={{ mb: 6 }}>
              <TypographyStyled variant='h5'>{`Bem-Vindo!`}</TypographyStyled>
              <Typography variant='body2'>Faça login na sua conta</Typography>
            </Box>
